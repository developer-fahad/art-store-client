          ...
          <table className="table">
            ...
            <thead>
              <tr>
                ...
                <th className="text-black font-bold text-lg">Processing Time</th>
                <th className="text-black font-bold text-lg">Customization</th>
            ...
            <tbody>
              {/* row 1 */}
              {
                loadedPaintings.map((painting, idx) => <tr key={painting._id}>
                  <th className="font-bold border-r text-rose-500">{idx +1}</th>
                  <td className="text-black font-bold">{painting.name}</td>
                  <td className="text-black font-bold"><img className="h-12 w-12" src={painting.photo} alt="" /></td>
                  <td className="text-black font-bold">{painting.process} days</td>
                  <td className="text-black font-bold">{painting.customization}</td>
                  <td className="text-black font-bold">${painting.price}</td>
                  <td className="text-black font-bold"><Link className="py-2 lg:px-3 px-5    bg-sky-600 rounded-full  text-white" to={`/details/${painting._id}`}><button className="">View Details</button></Link></td>
                </tr>)
              }
            </tbody>
          </table>
